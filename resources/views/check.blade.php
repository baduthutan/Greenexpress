                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="d-flex justify-content-center align-items-center flex-column h-100"
                                        ...
                                        <img src="{{ asset('img/cc_list.png') }}" class="mb-1" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <img src="{{ asset('img/sample-venmo.png') }}" width="150px" alt="venmo" class="mt-2">
                        @if ($bookings->payment_status == 'paid')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <img src="{{ asset('img/bca.png') }}" width="150px" alt="venmo" class="mt-0">

                        <!--                        <h4 class="mb-0 text-success">CITIZEN BANK</h4>-->
                        <img src="{{ asset('img/citizen.png') }}" width="150px" alt="venmo" class="mt-0 mb-1">
