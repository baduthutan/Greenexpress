    ...
    public static function generate_data($request, $paginate = true)
    {
        ...
        if ($request->booking_type !== 'charter') {
            $data->map(function ($item) use ($request) {
                ...
                //dump($item->seat_booked + $request->passanger_adult + $request->passanger_baby, $item->seat_booked,
                //$request->passanger_adult , $request->passanger_baby);
...
//                } elseif (($request->passanger_adult + $request->passanger_baby) >
//                    $item->total_seat) {
//                    $item->is_available = false;
//                }
...
//                dump(empty($item->bookings_count), $item->bookings_count, $item->is_available);
                return $item;
            });
        }
